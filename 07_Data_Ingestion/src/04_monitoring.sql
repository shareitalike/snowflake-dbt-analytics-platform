/* ==============================================================================
 * FILE: 04_monitoring.sql
 * PHASE: 07 - Data Ingestion
 * 
 * EXPLANATION: Creates secure views for monitoring Snowpipe ingestion latency and tracking Dead Letter Queue (DLQ) error volumes.
 * DESIGN DECISIONS: Utilizes SECURE VIEW to protect underlying system tables. Calculates latency by comparing file_last_modified from S3 with last_load_time in Snowflake.
 * WHY: Secure views provide a governed interface for BI tools and Airflow SLAs to monitor pipeline health without granting excessive permissions. Latency tracking is essential for meeting data freshness SLAs.
 * ============================================================================== */
