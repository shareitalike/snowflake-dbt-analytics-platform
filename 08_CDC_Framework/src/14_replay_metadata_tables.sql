/* ==============================================================================
 * FILE: 14_replay_metadata_tables.sql
 * PHASE: 08 - CDC Framework
 * 
 * EXPLANATION: Sets up the physical schema for surgical replay capabilities, including the Failed Batch Registry, the Replay Queue, and the immutable Recovery Audit Log.
 * DESIGN DECISIONS: TB_REPLAY_QUEUE tracks human or system-initiated replay requests by type (BATCH, DATE_RANGE, FILE). TB_RECOVERY_LOG captures a permanent JSON-based audit of every recovery action taken.
 * WHY: Data pipelines inevitably break or ingest corrupt data. Providing a formalized, trackable Replay Queue allows IT Operations to surgically replay specific bounded datasets without writing ad-hoc SQL, meeting compliance requirements via the Recovery Log.
 * ============================================================================== */
