/* ==============================================================================
 * FILE: 18_monitoring_views.sql
 * PHASE: 08 - CDC Framework
 * 
 * EXPLANATION: Creates operational views that traverse Snowflake's native INFORMATION_SCHEMA and ACCOUNT_USAGE alongside custom metadata to provide real-time platform health.
 * DESIGN DECISIONS: Calculates precise Data Latency SLA status by comparing the High_Watermark against CURRENT_TIMESTAMP(). Aggregates WAREHOUSE_METERING_HISTORY to track specific compute costs for the Transformation warehouse.
 * WHY: Native views abstract complex joins against system tables, providing Data Engineers and FinOps teams with immediate, actionable dashboards for pipeline freshness, task failures, and credit consumption.
 * ============================================================================== */
