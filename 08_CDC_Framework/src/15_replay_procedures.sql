/* ==============================================================================
 * FILE: 15_replay_procedures.sql
 * PHASE: 08 - CDC Framework
 * 
 * EXPLANATION: Defines reusable stored procedures for executing surgical replays (by Failed Batch, Date Range, Single File, or entire Business Domain) independent of Snowflake Stream states.
 * DESIGN DECISIONS: Replay procedures target the underlying Bronze base tables using timestamp or filename filters rather than relying on STR_SHOPIFY_ORDERS. They create new batch checkpoints to ensure the replay itself is audited.
 * WHY: Snowflake Streams are ephemeral; once consumed, the offset moves. If corrupt data reaches the Silver layer, you cannot "rewind" the stream. Replaying from the immutable Bronze base table ensures robust time-travel recovery without losing data.
 * ============================================================================== */
