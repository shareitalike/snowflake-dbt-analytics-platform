/* ==============================================================================
 * FILE: 10_merge_utilities.sql
 * PHASE: 08 - CDC Framework (Module 4)
 * 
 * EXPLANATION: Provides reusable utilities for the MERGE framework, including checksum generation and data quality (DQ) validation views.
 * DESIGN DECISIONS: Includes views to identify duplicate active SCD2 records and overlapping validity windows. Outlines a UDF for checksum generation.
 * WHY: Proactive data quality checks catch logical errors in the MERGE framework (like failing idempotency) before they impact downstream analytics. Centralizing checksum logic ensures consistency across all dimension models.
 * ============================================================================== */
