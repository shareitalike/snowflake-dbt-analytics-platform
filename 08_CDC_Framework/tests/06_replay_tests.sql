/* ==============================================================================
 * FILE: 06_replay_tests.sql
 * PHASE: 08 - CDC Framework
 * 
 * EXPLANATION: Unit tests for surgical data replay capabilities and stale stream recovery.
 * DESIGN DECISIONS: Simulates a failed batch in metadata, invokes the replay procedure, and validates both the batch status update and the immutable audit log entry. Tests SP_RECOVER_STALE_STREAM to ensure the AT(TIMESTAMP) syntax functions correctly.
 * WHY: Proving recovery procedures work *before* a production outage is critical. Validating the audit log ensures compliance teams have an irrefutable record of manual interventions.
 * ============================================================================== */
