...
EXPLANATION: Manages End-to-End Enterprise Data Lineage, tracking both technical data flows (Pipeline lineage) and conceptual derivations (Business lineage).
DESIGN DECISIONS: Represents the lineage as a Graph consisting of Nodes and directional Edges. Prepares the graph data to be flushed to Snowflake metadata tables for recursive querying.
WHY: Regulatory compliance requires knowing exactly where a KPI came from. Capturing both technical movement (API -> S3 -> Bronze) and business derivations (Order -> Sales Fact -> GMV KPI) bridges the gap between data engineering and business reporting.
==============================================================================
"""
import logging
