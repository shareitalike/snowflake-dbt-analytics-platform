/* ==============================================================================
 * FILE: 01_roles_and_hierarchy.sql
 * PHASE: 06 - Snowflake Platform
 * 
 * EXPLANATION: Defines the Enterprise Role-Based Access Control (RBAC) hierarchy, creating functional engineering, consumption, and service roles.
 * DESIGN DECISIONS: Implements a strict inheritance model where SYSADMIN owns all engineering and consumption roles. Service roles (Airflow, dbt) inherit from their respective human engineering counterparts.
 * WHY: Centralizing ownership under SYSADMIN prevents orphaned objects and simplifies governance. Inheriting service roles from engineering roles ensures developers can troubleshoot and debug automated pipelines with identical permissions.
 * ============================================================================== */
