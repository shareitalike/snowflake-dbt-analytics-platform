/* ==============================================================================
 * FILE: 01_databases.sql
 * PHASE: 06 - Snowflake Platform
 * 
 * EXPLANATION: Provisions the enterprise logical databases defining the medallion architecture (Bronze, Silver, Gold), plus utility databases for Metadata, Governance, and Reference.
 * DESIGN DECISIONS: Tailors DATA_RETENTION_TIME_IN_DAYS based on the layer: 1 day for transient raw/curated layers, 90 days for the Analytics (Gold) layer for executive time-travel needs.
 * WHY: Adjusting Time Travel retention drastically optimizes storage costs. Since Bronze and Silver can be completely re-run or re-built from source/dbt, paying for 90 days of Time Travel on those layers is financial waste.
 * ============================================================================== */
