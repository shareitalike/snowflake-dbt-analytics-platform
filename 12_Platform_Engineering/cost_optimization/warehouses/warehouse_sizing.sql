/* ==============================================================================
 * FILE: warehouse_sizing.sql
 * PHASE: 12 - Platform Engineering
 * 
 * EXPLANATION: Defines the provisioning configuration for the enterprise's virtual warehouses, purposefully sizing them according to distinct workload profiles (Ingest, Transform, dbt, BI).
 * DESIGN DECISIONS: Uses XSMALL with a 60s auto-suspend for I/O-bound Snowpipe ingestion, while using LARGE with Economy scaling for sequentially-heavy dbt model compilations. BI utilizes multi-cluster scaling.
 * WHY: Snowflake charges per second of active compute. Segmenting compute by workload allows precise auto-suspend tuning, ensuring you don't pay for idle time when ingestion finishes, but keeping BI cache warm enough to serve interactive dashboards.
 * ============================================================================== */
