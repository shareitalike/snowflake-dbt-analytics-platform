/* ==============================================================================
 * FILE: finops_dashboard_queries.sql
 * PHASE: 12 - Platform Engineering
 * 
 * EXPLANATION: Provides essential queries against the Snowflake ACCOUNT_USAGE schema to power an Enterprise FinOps dashboard, identifying expensive queries, warehouse utilization, and storage costs.
 * DESIGN DECISIONS: Filters specifically for queries running longer than 60 seconds and aggregates credit consumption by day and warehouse prefix (team/domain).
 * WHY: Empowering the FinOps team to attribute costs to specific business domains ensures accountability. Identifying long-running queries allows Data Engineering to proactively apply clustering or rewrite bad SQL rather than blindly upsizing warehouses.
 * ============================================================================== */
