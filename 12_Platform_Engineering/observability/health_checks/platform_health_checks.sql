/* ==============================================================================
 * FILE: platform_health_checks.sql
 * PHASE: 12 - Platform Engineering
 * 
 * EXPLANATION: Provides a suite of rapid health-check queries designed to run continuously via an orchestrator (like Airflow) to assess the holistic health of the Snowflake platform.
 * DESIGN DECISIONS: Evaluates Snowpipe load queues, Stream stale status, Warehouse queuing delays, and Resource Monitor budgets, returning a simple 'HEALTHY' or 'UNHEALTHY' boolean state for alerting.
 * WHY: Traditional monitoring focuses on pipeline execution states (Success/Fail). These checks monitor the underlying infrastructure health, identifying bottlenecks (like an under-provisioned warehouse causing queued queries) before they cause a pipeline SLA breach.
 * ============================================================================== */
