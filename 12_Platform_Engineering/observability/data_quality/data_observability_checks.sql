/* ==============================================================================
 * FILE: data_observability_checks.sql
 * PHASE: 12 - Platform Engineering
 * 
 * EXPLANATION: Implements the Data Observability framework across the 5 pillars (Freshness, Volume, Schema, Completeness, Accuracy) using native SQL queries.
 * DESIGN DECISIONS: Compares daily row counts against a 7-day rolling average using window functions to detect volume anomalies, and scans ACCOUNT_USAGE.COLUMNS to identify schema drift.
 * WHY: Silent data failures (e.g., a pipeline runs successfully but only ingests 5 rows instead of 5,000) destroy executive trust. These proactive checks guarantee that data anomalies are caught and flagged before they reach the BI dashboards.
 * ============================================================================== */
