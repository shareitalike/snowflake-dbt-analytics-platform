"""
==============================================================================
FILE: rotate_snowflake_keys.py
PHASE: 12 - Platform Engineering

EXPLANATION: A Python automation script designed to periodically rotate the RSA key pairs used for Snowflake service account authentication.
DESIGN DECISIONS: Generates a new 2048-bit RSA key pair locally, pushes the new private key to AWS Secrets Manager, and updates the public key in Snowflake via the ALTER USER command.
WHY: Key rotation is a standard compliance requirement (e.g., SOC2, ISO27001). Automating this process via a CI/CD cron job eliminates manual overhead and minimizes the risk of a compromised service account.
==============================================================================
"""
import os
import subprocess
