"""
==============================================================================
FILE: enterprise_master_orchestrator_dag.py
PHASE: 11 - Airflow Orchestration

EXPLANATION: Defines the Enterprise Master Orchestrator DAG, which acts as the "Brain" of the data platform by coordinating execution across AWS (S3), Snowflake (Snowpipe/Snowpark), and dbt Cloud.
DESIGN DECISIONS: Utilizes a mix of EmptyOperator for logical grouping and custom EnterpriseSnowflakeOperator for validating Snowflake states. Connects upstream data landing to downstream data modeling and BI reporting.
WHY: Having a single, high-level orchestrator provides a unified view of platform health. If a failure occurs deep in a child pipeline, the master DAG halts downstream processes (like dbt builds) to prevent cascading data corruption.
==============================================================================
"""
