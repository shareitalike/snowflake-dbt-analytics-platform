"""
==============================================================================
FILE: sla_miss_handler.py
PHASE: 11 - Airflow Orchestration

EXPLANATION: Defines a callback function triggered when an Airflow DAG breaches its Service Level Agreement (SLA).
DESIGN DECISIONS: Automatically parses the blocking_tis (Task Instances) to identify exactly which tasks are causing the delay. Routes the alert to a business-facing Slack channel instead of just engineering.
WHY: A task failure is an engineering problem, but an SLA miss (data latency) is a business problem that impacts downstream reporting and executive decision-making. Routing this separately ensures stakeholders are proactively notified of delays.
==============================================================================
"""
import logging
